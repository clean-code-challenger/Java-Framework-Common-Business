...
public class TruegardenerJSONReader
{
    public TruegardenerJSONReader()
    {
    ...
    public Object read(String strContent) throws Exception
    {
        it = new StringCharacterIterator(strContent);
        c = it.first();
        return read();
    }
    ...
    private Exception buildInvalidInputException()
    {
        return new Exception((new StringBuilder("Input string is not well formed JSON (invalid char ")).append(c).append(")").toString());
    }

    private Vector array() throws Exception
    {
