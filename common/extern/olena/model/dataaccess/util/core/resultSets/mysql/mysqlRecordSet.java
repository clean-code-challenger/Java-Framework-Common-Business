package common.extern.olena.model.dataaccess.util.core.resultSets.mysql;
...
public class mysqlRecordSet extends recordSet_Model{

	public mysqlRecordSet(IItem_Model itemInfos) {
		super(itemInfos);
	}
	@Override
